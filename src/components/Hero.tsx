...
const Hero = () => {
  ...
  return <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden pt-16 sm:pt-20 lg:pt-24">
      {/* Background image */}
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="backdrop-blur-sm rounded-xl lg:rounded-2xl p-6 sm:p-8 md:p-10 lg:p-12 border border-white/20 shadow-2xl bg-white/10 mx-auto max-w-4xl">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 animate-fade-in text-white leading-tight">
              <span className="block text-zinc-50">Acerte na sua</span>
              <span className="block text-[#16d30f]">decisão contábil</span>
            </h1>
            ...
            animationDelay: '0.6s'
              ...
              <Button size="lg" className="btn-hero-primary text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 w-full sm:w-auto whitespace-nowrap" onClick={() => window.open('https://wa.me/5555991467177', '_blank')}>
                <span className="hidden sm:inline">Falar com Especialista</span>
                <span className="sm:hidden">Falar Conosco</span>
                <ArrowRight className="ml-2 w-4 h-4 sm:w-5 sm:h-5" />
              </Button>
              <Button size="lg" variant="outline" onClick={() => scrollToSection('servicos')} className="btn-hero-outline text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 bg-green-600 hover:bg-green-500 w-full sm:w-auto whitespace-nowrap">
